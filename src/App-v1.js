...
export default function App() {
  ...
  function selectedMovieId(id) {
    setSelectedId((selectedId) => (id === selectedId ? null : id));
  }

  function handleAddMovies(object) {
    setWatched((movie) => [...movie, object]);
  }
    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {!isLoading && !error && (
            <MovieList movies={movies} selectedMovieId={selectedMovieId} />
          )}
...
function Movie({ movie, selectedMovieId }) {
  return (
    <li onClick={() => selectedMovieId(movie.imdbID)}>
